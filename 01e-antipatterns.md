...
> 💡 **なぜ過信は他の違反を引き起こすのか**
>
> アンチパターン6（過信）は、BL4「盲目的信頼の禁止」に直接対応しています。
> そしてBL4への自覚は、他のBright Lines違反を防ぐ力にもなります。
>
> - BL1違反（判断権の放棄）← なぜ？ AIの出力を盲目的に信頼しているから
> - BL2違反（検証なしの適用）← なぜ？ AIの出力を盲目的に信頼しているから
> - BL3違反（理解せずに採用）← なぜ？ AIの出力を盲目的に信頼しているから
>
> 運用上はBL1〜BL4すべて対等な「即座に停止・修正」です。
> しかし「なぜ違反してしまうのか」を理解する視点として、
> BL4（盲目的信頼）が他の3つの根底にある認知的態度であることを
> 知っておくと、Bright Lines全体への意識が高まります。
>
> 詳しくは [無慈悲な親切心](./00i-merciless-kindness.md) を参照してください。
